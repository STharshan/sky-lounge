          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <p className="text-white">
                          All content on this website (including text, images, graphics, and logos) is owned by or licensed to Sky Lounge.
                  ...
                  <section>
                      ...
                      <div className="text-white">
                          <p><strong>Sky Lounge</strong></p>
                          <p>Email: <a href="mailto:info@skyloungeleicester.co.uk" className="text-[#F0E0B0] hover:underline">info@skyloungeleicester.co.uk</a></p>
                          <p>Phone: +44 116 332 8639</p>
                          <p>Address: 63 Bedford St S, Leicester LE1 3JR, United Kingdom</p>
                      </div>
                  </section>
              </div>
          </div>
